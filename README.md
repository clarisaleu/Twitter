...
* [x] User sees an **indeterminate progress indicator** when any background or network task is happening **INCOMPLETE, just for loading tweets**
...
* [x] Use Parcelable instead of Serializable using the popular [Parceler library](http://guides.codepath.org/android/Using-Parceler). **Note, implemented Parcelable instead**
...
* [x] Change icon of app to Twitter Icon
* [x] Rounded profile images using Glide on timeline
* [x] Hide action bar on compose
* [x] Seperate Tweets on timeline with horizontal rule
